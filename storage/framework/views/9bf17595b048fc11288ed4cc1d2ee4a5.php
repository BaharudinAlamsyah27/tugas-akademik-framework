            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0" style="color: rgba(255,255,255,.5);">
                        ...
                        <i class="fa fa-heart color-danger" aria-hidden="true"></i> by Colorlib.com
                    </p>
                </div>
            </div>
        </div>
    </div>
</footer><?php /**PATH C:\laragon\www\akademik\resources\views/landing/footer.blade.php ENDPATH**/ ?>